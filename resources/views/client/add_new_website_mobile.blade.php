    ...
    <div class="row table-my">
        <form method="POST" action="#" id="editOrderForm" enctype="multipart/form-data">
            <div class="col-sm-12">
                <div class="table-wrapper">
                    <table class="table table-bordered th-my full-table">
                        ...
                        <tbody id="t_body_mobile" class="t_body qwer">
                            <tr id="tr_project_mobile" class="number-target row_table rt" style="display: none">
                                <td class="td-25">
                                    <div class="input-group">
                                        <input id="url" type="text" class="form-control input-lg" name="url[]" value="" placeholder="Enter Website URL" required>
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn-delete" id="btn_delete_mobile" type="button">
            ...
            <div class="col-sm-5 col-xs-12">
                <button id="add_proj" class="btn btn-default add_more_mobile" type="button">Add More</button>
            </div>
                ...
                <div class="card_inputs">
                    <div class="form-group col-md-5 col-lg-5 col-sm-5 col-xs-12">
                        ...
                        <input id="card_num" data-stripe="number" maxlength="16"
                               ...
                               name="card_number" value=" " required placeholder="Card Number" required>

                        <span class="help-block alert-danger">
                            <strong></strong>
                        </span>

                        <input id="cvc" type="password" maxlength="4" required data-stripe="cvc"
