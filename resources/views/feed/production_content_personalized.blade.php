...
<div class="col-xs-12 @if($count%2 != 0)left_feed_block @else right_feed_block @endif pid_help" data-count="{{ $count }}" data-pid="{{ $feed->project_id }}" id="production_content_personalized">

    <div class="@if($count%2 != 0)message_box_left @else message_box_right col-md-offset-6 @endif col-md-offset-6 col-xs-6">
        ...
        <div class="message arrow_box">
            <p style="margin: 0;" class="content_personalization">
