...
<head>
    ...
    <script src="{{ asset('js/ajs/apply_coupon.js') }}"></script>
            ...
            <nav class="navbar nobs_nav" role="navigation">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse collapsed" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right hdr-menu">
        ...
        <div class="container text_center">
            <div class="row">
                <div class="col-lg-12 col-h">
                    ...
                    <h3 class="h3">A minimum of $420 USD is required before checking out.</h3>
                    <h3 class="h3">Current cart total is $120 USD</h3>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('js/ajs/order_calculate.js') }}"></script>
