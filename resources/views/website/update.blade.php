...
<div class="col-md-12 modal_view">
    <div class="modal-body">
                        ...
                        <div class="col-md-12 nopadding">
                            <div class="col-sm-12 col-xs-12 first-block-mm nopadding">
                                ...
                                @endif
                                    ...
                                    {{--<input class="write-updates-mm" type="text" placeholder="Write and Updates">--}}
                                {{--</div>--}}
                                    <div class="col-md-10 col-sm-6 col-xs-9">
                            ...
                            <div class="massage-block col-md-12">
                                <div class="placement-updates-massage col-md-12 nopadding">
                                    <div class="header-massage-mm col-md-12 nopadding">
                                        ...
                                        <div class="massage-photo-mm col-md-2" style="background-image: url({{ asset('storage/photo_users/' . $feed->user->photo) }});"></div>
                                        @else
                                            @if($feed->user->bgc)
                                                <div class="user_photo col-md-1 col-sm-6 col-xs-6" style="background: linear-gradient(to bottom right, {{ unserialize($feed->user->bgc)[0] }}, {{ unserialize($feed->user->bgc)[1] }})">

                                                    <p class="name-user-mm">{{ substr($feed->user->first_name, 0, 1) }}</p><p class="surname-user-mm">{{ substr($feed->user->last_name, 0, 1) }}</p>
                                                </div>
                                            @else
                                                <div class="user_photo col-md-1 col-sm-6 col-xs-6" style="background: linear-gradient(to bottom right, #{{ dechex(mt_rand(1, 16777215)) }}, #{{ dechex(mt_rand(1, 16777215)) }})">
                                    ...
                                    @foreach($feed->update_clients as $comment)
                                        ...
                                        @endif
                                    {{--comments--}}
                                        <div class="col-md-offset-1 col-md-11 insides-massage-comment-mm" count="{{$loop->iteration}}">
                                    ...
                                    {{--end comments--}}
                                        {{--<div class="wrapper-for-btn col-md-offset-2 col-md-10 show-all " count="{{$loop->iteration}}">--}}
                                            {{--<button class="stop-btn-mm">Show All</button>--}}
                                        {{--</div>--}}
                                    ...
                                    {!! Form::open(['route' => 'store_comment_with_client', 'class' => 'form-horizontal', 'method'=>'POST' ]) !!}
        ...
        @endforeach
                    ...
                    {{--@role('super_admin|admin|pm|production|writer|editor')--}}
                        ...
                        <div class="col-md-12 nopadding">
                            <div class="col-sm-12 col-xs-12 first-block-mm nopadding">
                                ...
                                {{--</div>--}}
                                    <div class="col-md-10 col-sm-6 col-xs-9">
                                        {{--<input class="write-updates-mm" type="text" id="search_query" placeholder="Write and Updates">--}}
                                        <select multiple name="recipients[]" id="product2" size="2" data-placeholder="Write and Updates" class="create_camp_fields chosen-select form-control">
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}">{{ $user->first_name }} {{ $user->last_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="massage-block col-md-12">
                                    <div class="placement-updates-massage col-md-12 nopadding">
                                        ...
                                        @foreach($feed->update_nobses as $comment)
                                            @if($loop->index == 2)
                                                <div id="nobs_{{ $feed->id }}" style="display: none;">
                                            @endif
                                            {{--comments--}}
                                            <div class="col-md-offset-1 col-md-11 insides-massage-comment-mm" count="{{$loop->iteration}}">
                                                <i class="mdi mdi-share col-md-1 comment-mdi-share-mm"></i>
                                            ...
                                            @endif
                                        @endforeach
                                        <div><a href="#nobs_{{ $feed->id }}" class="full_prod2">Show all</a></div>
                                        {!! Form::open(['route' => 'store_comment_nobs', 'class' => 'form-horizontal', 'method'=>'POST' ]) !!}
...
//        console.log();
    ...
    $('.btn-send-mm').click(function (e) {
        ...
        var form = $(e.target).closest('form');
//        console.log();
        $(form).append($('#product2')).submit();
    });

//    $('.insides-massage-comment-mm').each(function(){
